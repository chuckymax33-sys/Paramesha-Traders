...
function ParameshaInvoiceTemplate({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "invoice-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "invoice-page", ref: printRef, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "top-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tax-title", children: "TAX INVOICE" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "items-table", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: enrichedItems.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
