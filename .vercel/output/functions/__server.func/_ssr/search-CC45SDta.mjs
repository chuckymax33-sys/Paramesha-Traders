...
import { u as useStore, C as COMPANIES, V as VEHICLES, s as supabase } from "./router-CzO775jj.mjs";
...
function SearchPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { title: "Search", subtitle: "Find any trip in seconds.", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.section, { initial: {
      ...
      opacity: 1,
      y: 0
    }, className: "glass-card p-6 sm:p-8 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Bill No", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: billNo, onChange: (e) => {
        setBillNo(e.target.value);
        setPage(0);
      }, className: "glass-select", placeholder: "Search bill no..." }) }),
