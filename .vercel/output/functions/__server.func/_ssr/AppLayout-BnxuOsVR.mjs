...
import { h as ClipboardList, F as FileText, S as Search, i as Printer, L as LogOut } from "../_libs/lucide-react.mjs";
const items = [
...
function GlassNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "glass-nav fixed top-0 inset-x-0 z-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 h-16 flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/daily-entry", className: "flex items-center gap-2 mr-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/pt.logo.png", alt: "Shanku Chakram Logo", className: "h-12 w-auto object-contain mix-blend-multiply" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold tracking-tight hidden sm:inline", children: "Shanku Chakram" })
    ] }),
