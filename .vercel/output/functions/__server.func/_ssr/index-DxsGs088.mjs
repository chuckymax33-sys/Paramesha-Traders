...
import { u as useStore } from "./router-CzO775jj.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { j as Lock, k as Sparkles, X, U as User } from "../_libs/lucide-react.mjs";
...
function Landing() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "relative min-h-screen flex items-center justify-center px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/pt.logo.png", alt: "Shanku Chakram Logo", className: "mx-auto mb-4 h-36 sm:h-48 w-auto object-contain mix-blend-multiply" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-5xl sm:text-6xl font-semibold tracking-tight bg-gradient-to-b from-foreground to-foreground/70 bg-clip-text text-transparent", children: "Shanku Chakram" }),
