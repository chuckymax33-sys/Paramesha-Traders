...
import { u as useStore, C as COMPANIES, V as VEHICLES, a as MONTHS, M as MATERIALS, s as supabase } from "./router-CzO775jj.mjs";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            trips.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `border-t border-white/40 hover:bg-white/40 ${!selectedIds.has(t.id) ? "opacity-50" : ""}`, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-5 py-3 font-semibold", children: [
                (Number(t.quantity) || 0).toFixed(2),
                " Tons"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-5 py-3 text-white/60", children: [
                "₹",
                Number(t.crusherRate) || 0
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-5 py-3 font-semibold", children: [
                "₹",
                ((Number(t.quantity) || 0) * (Number(t.crusherRate) || 0)).toLocaleString("en-IN")
              ] })
            ] }, t.id)),
