  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass-card max-w-md text-center p-10">
        ...
        <div className="mt-6">
          <Link to="/" className="glass-button inline-flex rounded-2xl px-4 py-2 text-sm font-medium">
            Go home
          </Link>
        </div>
      </div>
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass-card max-w-md text-center p-10">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="glass-button rounded-2xl px-4 py-2 text-sm font-medium">Go home</a>
        </div>
      </div>
    </div>
  );
